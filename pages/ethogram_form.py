...
from utils.calendar_utils import get_users, add_reminder, get_reminders, update_reminder, delete_reminder, get_all_reminders
...
def calendar_page():
    ...
    if not st.session_state.logged_in:
        ...
        events = [
            {
                "title": f"{user_dict_name.get(reminder[4], 'Unknown')} : {reminder[2]}",  # title
